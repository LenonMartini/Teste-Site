                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_object($query)) { ?>
                        <tr>                        
                            ...
                            <td>
                                <img src="<?= PATH_IMG."marca/$row->foto" ?>" width="150" />
                            </td>
                            <td>
